---
title: Profile of Open Source Project Contributors
excerpt: An overview of the scientific paper I wrote with classmates at PUC Minas: who contributes to GitHub's most popular open-source projects, and how experience shapes that participation.
readTime: 8 min read
---

This paper started as the 6th-period interdisciplinary project of the Software Engineering program at PUC Minas, written together with Pedro Braga, Arthur F. Costa, Fernando A. F. Ibrahim, Luca F. Azalim, and Renato M. A. Penna. Unlike most coursework projects, the goal here wasn't to build a product but to conduct original scientific research. It ended up being recognized as the best paper of the period.
